  ...
  <div class="min-h-screen bg-white">
    <main class="relative flex flex-col items-center justify-center w-full h-full">
      ...
      <section class="absolute top-24 left-1/4 w-3/5 h-3/4 bg-white rounded-3xl shadow-md">
        <h1 class="text-4xl font-medium text-gray-700 mb-4">LOG IN 2</h1>
        <form class="flex flex-col gap-4">
          ...
          <p class="text-center text-gray-500 text-sm mt-4">Don't have an account? <a href="register.php" class="text-blue-500 hover:underline">Sign Up</a></p>
        </form>
      </section>

      <div class="absolute w-16 h-8 bottom-4 right-4 flex justify-center items-center bg-blue-600 rounded-full text-white font-medium hover:bg-blue-700">
        <a href="{{ route('register') }}" class="w-full">Sign Up</a>
      </div>
    </main>
  </div>
</body>
